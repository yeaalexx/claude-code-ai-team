...
def run_tests():
    ...
    try:
        ...
        memory.add_learning(
            ...
            content="Database connection pooling with circuit breakers prevents cascading failures",
            project="acme-saas",
        )
        memory.add_learning(
        ...
        prompt_proj = context_builder.build_system_prompt(project="acme-saas")
        test("Project prompt generated", len(prompt_proj) > 100)
        test("Contains project name", "acme-saas" in prompt_proj)
